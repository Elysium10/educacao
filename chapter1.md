...
*** =sct
```{r}
test_output_contains("barplot(table(floor(rnorm(5000, 250, 50))), xlab="Números aleatórios", ylab="Frequências")", incorrect_msg = "Insira certinho a linha 100*12/10. Não o inicie esta linha com um `#`, senão o código não será  executado!")

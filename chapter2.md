...
*** =sct
```{r}
test_output_contains("7.215376", incorrect_msg = "Digite corretamente o valor da aceleração da gravidade e a expressão para a altura máxima alcançada pelo projétil.")
